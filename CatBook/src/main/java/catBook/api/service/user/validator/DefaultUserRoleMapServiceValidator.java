...
public class DefaultUserRoleMapServiceValidator extends GenesisServiceValidator<UserRoleMapRequestDTO> {
    ...
    @Override
    public void doValidate(BaseRequestResult result, UserRoleMapRequestDTO DTO) {
        idValidator.rejectInvalidID(result, DTO.getUserID(), "userID", User.class);
        idValidator.rejectInvalidID(result, DTO.getUserRoleID(), "userRoleID", UserRole.class);
    }
}
