...
public interface UserRoleMapService extends BaseCreateService<UserRoleMapResponseDTO, UserRoleMapRequestDTO>,
        BaseReadService<UserRoleMapResponseDTO, UserRoleMap, UserRoleMapParametersContainer> {
