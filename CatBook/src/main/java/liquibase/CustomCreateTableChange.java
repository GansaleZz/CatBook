...
@DatabaseChange(name="customCreateTable", description = "Custom Create Table", priority = ChangeMetaData.PRIORITY_DEFAULT)
public class CustomCreateTableChange extends AbstractChange implements ChangeWithColumns<ColumnConfig> {

    protected CustomCreateTableUtil customCreateTableUtil = CustomCreateTableUtil.getInstance();
    ...
    public CustomCreateTableChange() {
        super();
    ...
    public SqlStatement[] generateStatements(Database database) {
        ...
        // Just added this line to create specific columns automatically
        statement = customCreateTableUtil.addSpecificColumnsForNewTable(statement, database);
